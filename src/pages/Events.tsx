...
const Events = () => {
  ...
  const EVENTS = [
    ...
    {
      id: 2,
      title: t('events.list.workshop.title'),
      date: '2024-07-20',
      time: '02:00 PM - 06:00 PM',
      location: t('events.list.workshop.location'),
      type: 'upcoming',
      capacity: 50,
      spotsLeft: 15,
      description: t('events.list.workshop.description'),
      image: 'https://images.unsplash.com/photo-1511632765486-a01980e01a18?auto=format&fit=crop&q=80',
      registrationLink: '#register'
    },
    {
      id: 3,
      title: t('events.list.conference.title'),
      date: '2024-03-10',
      time: '10:00 AM - 04:00 PM',
      location: t('events.list.conference.location'),
      type: 'past',
      capacity: 150,
      spotsLeft: 0,
      description: t('events.list.conference.description'),
  ...
  return (
    <div className="pt-24 pb-16 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className={`grid gap-8 md:grid-cols-2 lg:grid-cols-3 transition-opacity duration-300 ${isLoading ? 'opacity-50' : 'opacity-100'}`}>
              ...
              <div className="p-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center text-gray-600 transition-transform duration-300 hover:translate-x-2">
                    ...
                    <span>{t('events.capacity')}: {event.capacity} {t('events.participants')}</span>
                  </div>
                </div>
